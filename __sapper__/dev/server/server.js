...
const Index = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `${($$result.head += `<title>Hurricane Cycles</title>`, "")}

	<div id="main" class="relative flex flex-col w-screen h-screen mt-12 text-center">
		<h2 class="text-xl md:text-3xl p-4 w-3/4 mx-auto md:-mt-12 mb-4 bg-white myDisplay-2 rounded-lg">We don't just sell bikes...WE ARE LIFE-IMPROVEMENT SPECIALISTS</h2>
		<div class="flex flex-row flex-wrap align-center justify-center md:p-4 bg-gray-900" id="contact-container">
			<div id="contact" class="my-2 md:mx-4 md:my-0 h-auto">
				...
				<a href="tel:(931) 250-7224" class="text-center text-white w-full">(931) 250-7224</a>
				<p class="text-white mt-2">Email:</p>
				<a href="mailto:hurricanecycles@icloud.com" class="text-center text-white w-full mb-2">hurricanecycles@icloud.com</a>
			...
			<div id="hours" class="my-2 md:mx-4 md:my-0 h-auto">
				...
				<p class="text-center text-white">Saturday: 10:00 AM - 5:00 PM</p>
				<p class="text-center text-white">Sunday: <span class="text-xl myDisplay-1">Closed</span></p>
			</div>
		</div>
		<div class="px-8 py-4" id="about-blurb">
			<p class="text-white text-xl md:text-2xl"> We don’t sell bikes. Hurricane Cycles uses the humble bicycle as a means to improve the lives of our customers. 
				We may have master certified bicycle mechanics on staff, but we are better described as life-improvement professionals. 
				You see, most people don’t want a bicycle merely for the sake of owning a bicycle. Perhaps you fall into the group that 
				simply wants to get from one place to another without a car and a bike sure beats walking. Or perhaps you are looking for 
				the comradery that comes from riding bikes with friends. Some people enjoy the mental and physical challenge of mountain biking.
			</p>
		</div>
	</div>`;
});
...
const About = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div id="main" class="relative flex flex-col w-screen h-screen mt-12">
		<h1 class="w-full text-white text-center text-md md:text-4xl">Determination | Faith | Community | Lifestyle</h1>
		<div class="flex flex-row flex-wrap w-full justify-center items-center my-8" id="about-main-info">
			<div class="w-1/4" id="about-pic">
				<img src="../../images/andrew_holly.jpg" class="rounded-lg" alt="Andre and Holly">
			</div>
			<div class="w-2/4 px-8" id="about-text">
				<p class="text-white">
					...
					hard work in the dirt to have a new place to play. It was an awkward journey filled with many setbacks and injuries but the 
					lessons I learned along the way have fueled my passion for bikes in a way that nothing else could. Hurricane Cycles 
					was born as a means to share that passion. Since its humble inception in 2016 we have served hundreds of returning 
					customers and helped to boost the growth of bike riding in the area in a way that would not have been possible otherwise. 
					It has been an honor to serve this community and see this small business grow to the point that we can now give back in a very real way. 
					Bringing the trails at Cumberland Mountain to life has been one of my greatest accomplishments. 
					To see the many smiles and the families who are now getting outside and doing things together because of the trails is 
					something that will stay with me for life. I moved back to Crossville because I love it here and it is my deepest honor to 
					continue giving back and making my small town just a little bit better. Thank you to all of the amazing customers who have made this journey possible. 
					Together we will continue making the world a better place, one bicycle at a time.
				</p>
			</div>
		...
		<div class="flex flex-col p-4 bg-gray-900" id="video-container">
			...
			<iframe class="mx-auto rounded-lg shadow-xs" width="1020" height="630" src="https://www.youtube.com/embed/4_s1X0CRF4E" title="Hurricane Video - 1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
			</iframe>
		</div>
...
const css = {
	code: "#blog-list.svelte-h4sv1v{z-index:1000 !important}ul.svelte-h4sv1v{margin:0 0 1em 0;line-height:1.5}ul.svelte-h4sv1v>li.svelte-h4sv1v:nth-child(even){background-color:#e7e7e7;color:black}ul.svelte-h4sv1v>li.svelte-h4sv1v:nth-child(odd){background-color:#1a202c;color:white}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<script context=\\\"module\\\">\\n\\texport function preload({ params, query }) {\\n\\t\\treturn this.fetch(`blog.json`).then(r => r.json()).then(posts => {\\n\\t\\t\\treturn { posts };\\n\\t\\t});\\n\\t}\\n</script>\\n\\n<script>\\n\\texport let posts;\\n</script>\\n\\n<style>\\n\\t#blog-list {\\n\\t\\tz-index: 1000 !important;\\n\\t}\\n\\n\\tul {\\n\\t\\tmargin: 0 0 1em 0;\\n\\t\\tline-height: 1.5;\\n\\t}\\n\\n\\tul > li:nth-child(even) {\\n\\t\\tbackground-color: #e7e7e7;\\n\\t\\tcolor: black;\\n\\t}\\n\\n\\tul > li:nth-child(odd) {\\n\\t\\tbackground-color: #1a202c;\\n\\t\\tcolor: white;\\n\\t}\\n</style>\\n\\n<svelte:head>\\n\\t<title>Blog</title>\\n</svelte:head>\\n\\n<div class=\\\"flex flex-col w-5/6 mx-auto text-center\\\" id=\\\"blog-list\\\">\\n\\t<h1 class=\\\"text-5xl text-center text-white\\\">Hurricane Blog</h1>\\n\\t<ul class=\\\"list-none list-inside\\\">\\n\\t\\t{#each posts as post}\\n\\t\\t\\t<!-- we're using the non-standard `rel=prefetch` attribute to\\n\\t\\t\\t\\t\\ttell Sapper to load the data for the page as soon as\\n\\t\\t\\t\\t\\tthe user hovers over the link or taps it, instead of\\n\\t\\t\\t\\t\\twaiting for the 'click' event -->\\n\\t\\t\\t<li  class=\\\"text-white py-4 my-4 rounded-lg\\\"><a rel='prefetch' href='blog/{post.slug}' class=\\\"w-full\\\">{post.title}</a></li>\\n\\t\\t{/each}\\n\\t</ul>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAaC,UAAU,cAAC,CAAC,AACX,OAAO,CAAE,IAAI,CAAC,UAAU,AACzB,CAAC,AAED,EAAE,cAAC,CAAC,AACH,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,CACjB,WAAW,CAAE,GAAG,AACjB,CAAC,AAED,gBAAE,CAAG,gBAAE,WAAW,IAAI,CAAC,AAAC,CAAC,AACxB,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,KAAK,AACb,CAAC,AAED,gBAAE,CAAG,gBAAE,WAAW,GAAG,CAAC,AAAC,CAAC,AACvB,gBAAgB,CAAE,OAAO,CACzB,KAAK,CAAE,KAAK,AACb,CAAC\"}"
};
...
const Index$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="flex flex-col w-5/6 mx-auto text-center svelte-h4sv1v" id="blog-list">
		<h1 class="text-5xl text-center text-white">Hurricane Blog</h1>
		<ul class="list-none list-inside svelte-h4sv1v">
			${each(posts, (post) => `
				<li class="text-white py-4 my-4 rounded-lg svelte-h4sv1v"><a rel="prefetch" href="blog/${escape(post.slug)}" class="w-full">${escape(post.title)}</a></li>`)}
		</ul>
	</div>`;
});
...
const Slug = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	<div class="flex flex-col no-wrap" id="blog-post">
		<h1 class="text-4xl text-center text-white">${escape(post.title)}</h1>

		<div class="content w-5/6 mx-auto px-8 py-4 svelte-1u80ehe">
			${post.html}
		</div>
	</div>`;
});

/* src\components\Hamburguer.svelte generated by Svelte v3.12.1 */

const Hamburguer = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { expand = false } = $$props;

	if ($$props.expand === void 0 && $$bindings.expand && expand !== void 0) $$bindings.expand(expand);

	return `<button class="flex items-center px-3 py-2 border rounded text-white-200
	  bg-black hover:text-white hover:border-white">
...
const NavLink = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	let { segment, href, text, rel = "" } = $$props;
	...
	return `<a${add_attribute("rel", rel, 0)}${add_attribute("href", href, 0)} class="block mt-4 lg:mx-4 lg:inline-block lg:mt-0 ${escape(segment === href ? 'text-white' : 'text-teal-200')}
	  hover:text-white">
	  ${escape(text)}
	</a>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  let expand = false;
	...
	return `<nav class="fixed z-10 text-white w-full lg:w-1/2 flex items-center justify-between flex-wrap
	  ...
	  <div class="block lg:hidden">
	    ${validate_component(Hamburguer, 'Hamburguer').$$render($$result, { expand: expand }, {}, {})}
	  </div>
	  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
	    <div class="${escape(!expand && 'hidden')} lg:block text-sm lg:flex-grow">
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<div id="hero" class="relative flex flex-row w-screen h-auto -z-100 mt-16 md:mt-0">
	  <img src="../../images/splotch-hero-2.jpg" alt="Hurricane hero" class="relative w-full h-auto -z-10 object-cover">
	  <div id="logo" class="absolute flex justify-center items-center md:ml-0 w-full md:w-1/2 h-full -z-9 px-24 mt-12 md:p-24">
	    <img src="../../images/hurricane_logo.png" alt="Hurricane logo">
	  </div>
	</div>`;
});
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `${($$result.head += `<link href="https://fonts.googleapis.com/css2?family=Saira+Stencil+One&family=Montserrat&display=swap" rel="stylesheet">`, "")}
