...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  let expand = false;
	...
	return `<nav class="fixed z-10 text-white w-full md:w-1/2 flex items-center justify-between flex-wrap
