...
export const components = [
	...
	{
		js: () => import("../../../routes/newsletter.svelte"),
		css: "__SAPPER_CSS_PLACEHOLDER:newsletter.svelte__"
	},
	{
...
if (typeof window !== 'undefined') {
	import("N:/dev/basic_web/hurricane_basic/node_modules/sapper/sapper-dev-client.js").then(client => {
